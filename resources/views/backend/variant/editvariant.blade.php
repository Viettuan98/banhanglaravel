                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return del_variant()" class="btn btn-warning"
                                        href="admin/product/del-variant/{{$variant->id}}/{{$value->id}}/{{$product->id}}"
                                        role="button">Xoá</a>
                                </td>
                            </tr>
                            @endforeach
...
<script>
    function del_variant()
                {
    	            return confirm('Bạn có muốn xoá biến thể ? ');
                }
</script>
@endsection
